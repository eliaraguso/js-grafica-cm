...
let totaleCelle = parseInt(prompt("Inserisci il numero di celle che andranno a formare il campo da gioco in modo che sia sempre una scacchiera quadrata. Il valore dev'essere compreso tra 10 e 100 e gli unici valori consentiti corrispondo al quadrato del numero di celle o colonne di cui sarà composto il campo (4, 9, 16, 25, 36, 49, 64, 81, 100)"));
...
// verifico che l'input utente sia un numero e che sia compreso tra 10 e 100
while (isNaN(totaleCelle)) {
    totaleCelle = parseInt(prompt("Ti ho detto di inserire un numero!!!!"));
}

// che sia compreso tra 10 e 100
while (totaleCelle < 10 || totaleCelle >100) {
    totaleCelle = parseInt(prompt("Ti ho detto di inserire un numero tra 10 e 100 !!!!"));
}

// e che sia sempre il quadrato del numero di righe o colonne così da formare sempre una scacchiera quadrata
while (totaleRighe != parseInt) {
